...
For the last three decades evolutionary archaeologists have adapted macro-evolutionary (phylogenetic) methods to better understand the nature of change in material culture (O'Brien and Lyman, 2000 Bettinger, 2008; Shennan, 2008, 2009; Riede et al. 2019; Ivanovaite et al. 2019). Through this notion of culture as a multi-generational system of information transmission *sensu* Boyd and Richerson (1985) past communities of practice, estimations of contact and mixing have been investigated, and the nature of  transmission hypothesised (O'Brien et al. 2008; Collard and Shennan, 2008; Riede 2011).  
...
hm1 <- g2 %<+% dataset_three_unique_meta + 
  geom_tippoint(aes(shape = material, colour = shape), size = 4) +
  labs(shape = "Material", colour = "Shape") +
...
hm1a <- select(dataset_three_unique, -sandstone, -shale, -wrpebble, -asymmetric, -oval, -round)

gheatmap(hm1, hm1a) + scale_fill_brewer(palette="Set4")
...
hm2 <- g4 %<+% dataset_three_unique_meta + 
  geom_tippoint(aes(shape = material, colour = shape), size = 4) +
  labs(shape = "Material", colour = "Shape") +
  scale_shape_discrete(name = "Material", labels = c("Sandstone", 
                                                      "Shale", 
...
gheatmap(hm2, hm1a) + scale_fill_brewer(palette="Set4")
...
hm3 <- g6 %<+% dataset_three_unique_meta + 
  geom_tippoint(aes(shape = material, colour = shape), size = 4) +
  labs(shape = "Material", colour = "Shape") +
  scale_shape_discrete(name = "Material", labels = c("Sandstone", 
                                                      "Shale", 
...
gheatmap(hm3, hm1a) + scale_fill_brewer(palette="Set4")
...
hm4 <- g8 %<+% dataset_three_unique_meta + 
  geom_tippoint(aes(shape = material, colour = shape), size = 3) +
  labs(shape = "Material", colour = "Shape") +
  scale_shape_discrete(name = "Material", labels = c("Sandstone", 
                                                      "Shale", 
                                                      "Water-Rounded Pebble")) +
  ...
  theme(plot.title = element_text(hjust = 0.5, 
                                  margin = margin(0,0,10,0)))
hm4a <- dataset_three_clean %>% select(-sandstone, -shale, -wrpebble, -asymmetric, -oval, -round)

gheatmap(hm4, hm4a) + scale_fill_brewer(palette="Set4")
...
hm5 <- g10 %<+% dataset_three_unique_meta + 
  geom_tippoint(aes(shape = material, colour = shape), size = 3) +
  labs(shape = "Material", colour = "Shape") +
  scale_shape_discrete(name = "Material", labels = c("Sandstone", 
                                                      "Shale", 
...
gheatmap(hm5, hm4a) + scale_fill_brewer(palette="Set4")
